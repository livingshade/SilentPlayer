...
char *player_app_discord_presence_configure(PlayerApp *app, const char *application_id);
...
char *player_app_queue_clear(PlayerApp *app);
...
char *player_app_recent_playlists(PlayerApp *app, size_t limit);
